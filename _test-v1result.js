async function main() {
  ...
  const result = PDFJS.getDocument({data: createPdf()});
  console.log('result type:', typeof result);
  console.log('is task:', result instanceof require('pdf-parse/lib/pdf.js/v1.10.100/build/pdf.js').PDFDocumentLoadingTask);
  ...
  console.log('doc is actually:', typeof doc);
  console.log('doc has getPage:', typeof doc.getPage);
}
